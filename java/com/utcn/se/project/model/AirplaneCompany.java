...
public class AirplaneCompany {
    ...
    public AirplaneCompany(int idCompany, String name, int capital, String country, String city, String street, int streetNumber, int numberOfEmployees) {
    ...
    public AirplaneCompany(String name, int capital, String country, String city, String street, int streetNumber, int numberOfEmployees) {
        this.name = name;
        this.capital = capital;
        this.country = country;
        this.city = city;
    ...
    public AirplaneCompany(AirplaneCompanyBuilder builder) {
    ...
    public static class AirplaneCompanyBuilder {
        ...
        public AirplaneCompany build() {
            return new AirplaneCompany(this);
        }
    }
}
